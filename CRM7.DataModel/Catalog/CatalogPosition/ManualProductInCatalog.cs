...
{
    /// <summary>
    /// Позиция продукта, добавленного вручную, в каталоге.
    /// </summary>
    [Table(nameof(ManualProductInCatalog))]
    public class ManualProductInCatalog : ICatalogPosition
    {
        public ManualProductInCatalog()
        {
            Id = Guid.NewGuid();
        }
