...
namespace Client
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var consol = pmod.AddConsolidation(new Consolidation() { Name = "PTFE" });
            ...
            var cont = man.GetAllContacts().First();
            ...
            var EAMod = pmod.AddElectricActuatorModel(new ElectricActuatorModel(), manufac.Id, rotorType.Id);
